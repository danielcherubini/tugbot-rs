...
mod tests {
    ...
    #[test]
    fn twitter_rewrite() {
        match super::fx_rewriter("https://twitter.com/davidbcooper/status/1684840110259404802") {
            None => assert!(false),
            Some(url) => assert_eq!(
                url,
    ...
    #[test]
    fn x_rewrite() {
        match super::fx_rewriter("https://x.com/davidbcooper/status/1684840110259404802") {
            None => assert!(false),
            Some(url) => assert_eq!(
                url,
                "https://vxtwitter.com/davidbcooper/status/1684840110259404802",
